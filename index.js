...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@fitsync.31j5t.mongodb.net/?retryWrites=true&w=majority&appName=FitSync`;
...
async function run() {
  try {
    ...
    const database = client.db("FitSync");
